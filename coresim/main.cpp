...
void run_scenario() {
    ...
    for (int i = 0; i < 40; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            printf("%.6f,%.6f,%.6f,%.6f, ",
                   1.0 * telemetryStatistics[i][j*7+4] / telemetryStatistics[i][j*7+6],
                   1.0 * telemetryStatistics[i][j*7+5] / telemetryStatistics[i][j*7+6],
                   1.0 * telemetryStatistics[i][j*7+1] / telemetryStatistics[i][j*7],
                   1.0 * telemetryStatistics[i][j*7+2] / telemetryStatistics[i][j*7]
            );
        }
        printf("\n");
    }
